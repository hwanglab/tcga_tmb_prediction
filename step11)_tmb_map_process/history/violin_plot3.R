...
output_path<-"E:/Hongming/projects/tcga-bladder-mutationburden/heterogeneity/gene_plots/pred_log/"
...
gene_pvalue<-read_excel(paste(excel_output," gene_log10_pvalues.xlsx",sep=""),sheet="Sheet1")
...
write.xlsx(gene_pvalue,paste(excel_output,'gene_log10_pvalues.xlsx'),sheetName="Sheet1",
