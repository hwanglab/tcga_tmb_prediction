...
ggsurvplot(fit1,pval = TRUE,
           #risk.table = TRUE,
           legend=c(0.8,0.9),
           legend.labs=c("High-High-Low (HHL) (42)","High (w/o HHL) (84)","Low-High-Low (LHL) (19)","Low (w/o LHL) (102)"),
           legend.title="Categories",
           xlab='Time in Months')+ggtitle("Selected Bladder Cohort")
