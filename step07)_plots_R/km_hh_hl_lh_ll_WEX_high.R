...
# high_low vs high_low vs low_high vs low_low for only WES high patients
...
ggsurvplot(fit1,pval = TRUE,
           #risk.table = TRUE, 
           legend=c(0.8,0.9),
           legend.labs=c("High-High-High (48)","High-High-Low (42)","High-Low-High (18)","High-Low-Low (18)"),
