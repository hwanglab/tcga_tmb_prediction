...
% end
%%----
level=varargin{1}; %% added by Hongming Xu
%%
...
if xPos + width - 1 > widthLevel % modidifed by Hongming Xu >= is changed into >
    error('openslide:openslide_read_region',...
...
if yPos + height - 1 > heightLevel % modidifed by Hongming Xu >= is changed into >
    error('openslide:openslide_read_region',...
