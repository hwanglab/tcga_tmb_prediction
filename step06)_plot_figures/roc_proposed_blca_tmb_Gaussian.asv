...
%           svm for gaussian kernels were used to make predictions
...
load(strcat(matpath,'P_E_RTS.mat'))
response_apc=labels;
p_e_apc=SSC;
...
legend([h1,h2,h3,h4,h5,h6],{'P-E-TD (AUC=0.683)','P-E-CN (AUC=0.687)','P-E-RTS (AUC=0.753)','P-InceptionV3 (AUC=0.664)','P-Resnet50 (AUC=0.690)','P-Xception (AUC=0.752)'});
