...
function cross_validation_SVM_classifier_simple_voting
...
% featPath={'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\7)mutation_prediction_clustering\low\',...
...
for ip=1:length(featPath)
    ...
    for im=1:numel(mats)
        ...
        %Ftrain=[Ftrain;feat_out(:,41:112)]; % mlbp features
        feat_out=image_features;
        Ftrain=[Ftrain;feat_out];
...
ComNum=500;        % number of PCA components
