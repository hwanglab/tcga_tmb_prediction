% this function is used for 5-folds cross valition by SVM classifier with Gaussian kernel
% we test it for 3 class classifications: mutation burden low, mid and high
% author: Hongming Xu, Cleveland Clinic, May 2018
% you may modify or use it, but you need give the credit for original
% author


function cross_validation_SVM_classifier_simple_mean_transfer
...
%featPath={'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\7)transfer_learning\low\',...
%          'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\7)transfer_learning\mid\',...
%          'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\7)transfer_learning\high\'};
%           % 50 kmeans clusters
    
featPath={'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\8)transfer_learning_all10x\low\',...
         'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\8)transfer_learning_all10x\mid\',...
         'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\8)transfer_learning_all10x\high\'};
%           % all patche features 43.13
