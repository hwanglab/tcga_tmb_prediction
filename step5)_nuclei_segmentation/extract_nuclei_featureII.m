function extract_nuclei_featureII
...
feat_output={'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\5)mutation_prediction_cellular_featuresII\low\',...
    'E:\Hongming\projects\tcga-bladder-mutationburden\featureoutput\5)mutation_prediction_cellular_featuresII\mid\',...
...
for ip=1:length(imagePath)
    ...
    for im=1:numel(imgs)
        ...
        feat_cell=xu_feature_bins_extraction(ffn_img,fb);
...
%              close all;
%         end
         save(strcat(feat_output{ip},patientID,'.mat'),'feat_cell');
