...
%  Inputs:
%  -bwTissue: the binary mask foreground (manually labeled)
%  -ppt: the percent of the largest intrested value (the interest value is
...
function [top_left2,bottom_right2]=xu_SelectImageTiles_VII(bwTissue,ppt,tileSize)
